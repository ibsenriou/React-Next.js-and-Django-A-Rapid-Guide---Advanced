...
class OrderAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            stripe.api_key = 'sk_test_51LegaFETXQgXEzieZNhD2gVhe6pTOFxO9fUfRJb1svH0NeusD8b1kBI3uPYgjQuUDiCOGstzLDhlUYH5rEZPBgYi00lAub8RSq'
...
class OrderConfirmAPIView(APIView):
    ...
    def post(self, request):
        ...
        send_mail(
            ...
            from_email='from@email.com',
            recipient_list=['ambassador@admin.com']
        )
